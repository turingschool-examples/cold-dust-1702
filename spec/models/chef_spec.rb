...
RSpec.describe Chef, type: :model do
  ...
  describe 'instance methods' do
    it '#most_used' do
      ...
      expect(chef1.most_used.to_a).to eq([ingredient2, ingredient3, ingredient1])
    end
    ...
    it '#most_used' do
      ...
      result = chef1.ingredients_used.map { |e| e.name  }.sort

      expect(result).to eq(['Lettuce', 'Penne Pasta', 'Ranch Dressing', 'Red Garlic Sauce', 'Sausage'])
    end
  end
end
